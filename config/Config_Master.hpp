...
/* System Settings */
    ...
    escapeMenu_displayText = "Project Life Simplified"; //Text displayed in the escape menu. Make it short.. around 20 characters.
    ...
    bank_cop = 7000000; //Amount of cash in bank for new cops
    bank_civ = 3000000; //Amount of cash in bank for new civillians
    bank_med = 6500000; //Amount of cash in bank for new medics

    paycheck_cop = 65000; //Payment for cops
    paycheck_civ = 35000; //Payment for civillians
    paycheck_med = 65000; //Payment for medics
    ...
    /* ! --- Do not change --- ! */
    framework_version = "5.0.0 - Modified by The-Programmer";
    /* ------------------------- */
